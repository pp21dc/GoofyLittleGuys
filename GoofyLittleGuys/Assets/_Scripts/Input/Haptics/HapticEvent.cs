...
public class HapticEvent : ScriptableObject
{
	...
	[Tooltip("Low rumble frequency. Typically used for deeper rumbles.\nMost cases you just make low and high the same number unless you know what you're doing.")][Range(0, 1)] 
	public float lowFrequency;

	[Tooltip("High rumble frequency. Typically used for finer vibrations.\nMost cases you just make low and high the same number unless you know what you're doing.")][Range(0, 1)] 
	public float highFrequency;

	[Tooltip("The length in seconds that this haptic event should last for.")] [Min(0.1f)] 
